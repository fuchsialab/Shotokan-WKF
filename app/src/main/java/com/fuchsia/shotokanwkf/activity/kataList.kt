...
import com.fuchsia.shotokanwkf.adapter.kataAdapter
...
class kataList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkConnection()
        recview = findViewById<View>(R.id.recycle) as RecyclerView
        recview!!.layoutManager = LinearLayoutManager(this)
        val options = FirebaseRecyclerOptions.Builder<katamodel>()
            .setQuery(FirebaseDatabase.getInstance().reference.child("Katakt"),
                katamodel::class.java)
            .build()
        adapter = kataAdapter(options)
