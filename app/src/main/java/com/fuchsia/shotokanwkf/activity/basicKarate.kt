...
import com.fuchsia.shotokanwkf.adapter.basicAdapter
...
class basicKarate : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recview = findViewById<View>(R.id.recycleS) as RecyclerView
        recview!!.layoutManager = LinearLayoutManager(this)
        val options = FirebaseRecyclerOptions.Builder<basicmodel>()
            .setQuery(
                FirebaseDatabase.getInstance().reference.child("Basickt"),
                basicmodel::class.java
            )
            .build()
        adapter = basicAdapter(options)
    ...
    fun bannerAds() {
        ...
        mAdView = AdView(this@basicKarate)
