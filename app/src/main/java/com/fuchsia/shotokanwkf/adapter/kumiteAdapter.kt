...
import com.fuchsia.shotokanwkf.activity.kumiteActivity.Companion.instance
import com.fuchsia.shotokanwkf.model.kumitemodel
import com.fuchsia.shotokanwkf.activity.videoPlayer
import com.google.android.gms.ads.FullScreenContentCallback

class kumiteAdapter(options: FirebaseRecyclerOptions<kumitemodel?>?) :
    FirebaseRecyclerAdapter<kumitemodel, kumiteAdapter.myviewholder>(
        options!!
    ) {
    ...
    override fun onBindViewHolder(holder: myviewholder, position: Int, kumitemodel: kumitemodel) {
        holder.textView.text = kumitemodel.name
        holder.cardView.setOnClickListener { view ->
            ...
            if (preferences.getBoolean("isPremium",true) ){
                ...
                intent.putExtra("nam", kumitemodel.url)
