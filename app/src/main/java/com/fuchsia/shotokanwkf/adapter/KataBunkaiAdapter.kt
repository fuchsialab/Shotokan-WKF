...
import com.fuchsia.shotokanwkf.activity.KataBunkai.Companion.instance
import com.fuchsia.shotokanwkf.model.KataBunkaimodel
import com.fuchsia.shotokanwkf.activity.videoPlayer
import com.google.android.gms.ads.FullScreenContentCallback

class KataBunkaiAdapter(options: FirebaseRecyclerOptions<KataBunkaimodel?>?) :
    FirebaseRecyclerAdapter<KataBunkaimodel, KataBunkaiAdapter.myviewholder>(
        options!!
    ) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): myviewholder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.katacur, parent, false)
        return myviewholder(view)
    }

    override fun onBindViewHolder(holder: myviewholder, position: Int, model: KataBunkaimodel) {
